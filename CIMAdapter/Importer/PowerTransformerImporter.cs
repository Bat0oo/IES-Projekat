...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
        ...
        {
            SortedDictionary<string, object> cimGroundDisconnectors = concreteModel.GetAllObjectsOfType("FTN.GroundDisconnector");
            if (cimGroundDisconnectors != null)
            {
                foreach (KeyValuePair<string, object> cimGroundDisconnectorPair in cimGroundDisconnectors)
                {
                    FTN.GroundDisconnector cimGroundDisconnector = cimGroundDisconnectorPair.Value as FTN.GroundDisconnector;
        ...
        private ResourceDescription CreateGroundDisconnectorResourceDescription(FTN.GroundDisconnector cimGroundDisconnector)
        {
            ...
            {
                long gid = ModelCodeHelper.CreateGlobalId(0, (short)DMSType.GROUNDDISCONNECTOR, importHelper.CheckOutIndexForDMSType(DMSType.GROUNDDISCONNECTOR));
                rd = new ResourceDescription(gid);
